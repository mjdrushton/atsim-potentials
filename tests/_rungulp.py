...
GULP_BIN = "gulp-6.0"
GULP_FOUND = distutils.spawn.find_executable(GULP_BIN)
...
def runGULP(infile, outfile, cwd = None):  
  import subprocess
  popen = subprocess.Popen(GULP_BIN, cwd = cwd, shell = True, stdin = subprocess.PIPE, stdout = subprocess.PIPE, close_fds=True)
